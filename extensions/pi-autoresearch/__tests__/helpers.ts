 ...
 */
export function makeCommit(repoDir: string, message: string, files?: Record<string, string>): string {
  if (files) {
 ...
 */
export function createWorktree(repoDir: string, sessionId: string): { branchName: string; worktreePath: string } {
